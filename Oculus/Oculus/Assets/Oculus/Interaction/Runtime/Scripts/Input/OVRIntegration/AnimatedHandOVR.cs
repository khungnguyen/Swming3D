...
namespace Oculus.Interaction.Input
{
    public class AnimatedHandOVR : MonoBehaviour
    {
        ...
        protected int _animLayerIndexThumb = -1;
        protected int _animLayerIndexPoint = -1;
        protected int _animParamIndexFlex = -1;

        protected bool _isPointing = false;
        protected bool _isGivingThumbsUp = false;
        protected float _pointBlend = 0.0f;
        protected float _thumbsUpBlend = 0.0f;
        ...
        protected virtual void UpdateCapTouchStates()
        {
