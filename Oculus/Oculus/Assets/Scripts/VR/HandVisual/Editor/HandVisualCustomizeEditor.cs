...
[UnityEditor.CustomEditor(typeof(HandVisualCustomize))]
public class HandVisualCustomizeEditor : Oculus.Interaction.Hands.Editor.HandVisualEditor
{
    ...
    //     HandVisualCustomize visual = (HandVisualCustomize)target;
    ...
    // private void InitializeSkeleton(HandVisualCustomize visual)
    // {
    ...
    // private void AutoMapJoints(HandVisualCustomize visual)
    // {
    //     if (Hand == null)
    //     {
    //         InitializeSkeleton(visual);
    ...
    // private string FbxBoneNameFromHandJointId(HandVisualCustomize visual, HandJointId handJointId)
    // {
